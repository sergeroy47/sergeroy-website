    ...
    try {
      ...
      if (typeof GALERIES !== 'undefined') {
        GALERIES.forEach(ref => {
          ...
          // Le fichier galeries-contenu.js fait foi
          if (ref.photos && ref.photos.length > 0) loc.photos = ref.photos;
          loc.vignette = ref.vignette || loc.vignette;
          loc.titre = ref.titre || loc.titre;
          loc.sousTitre = ref.sousTitre || loc.sousTitre;
          loc.intro = ref.intro || loc.intro;
          loc.etiquette = ref.etiquette || loc.etiquette;
        });
      }
